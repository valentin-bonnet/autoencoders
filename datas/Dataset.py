...
class Dataset():
    def __init__(self, dataset_name, batch_size=128, buffer_size=10000, use_Lab=False):
        ...
        if dataset_name == 'DAVIS':
            ...
            self.train_ds, self.val_ds, self.train_size, self.val_size = OxuvaLoader.oxuva_loader_v2('/content/drive/My Drive/Colab Data/Datasets/oxuva_256/', seq_size=self.sequence_length)
            self.shape = 256
            self.test_ds = DAVISLoader.davis_loader(seq_size=self.sequence_length)
