...
class KAST(tf.keras.Model):
    ...
    def compute_loss(self, inputs):
        ...
        print('Max L: ', tf.reduce_max(output_v[:, :, :, :, 0]))
        print('Max a: ', tf.reduce_max(output_v[:, :, :, :, 1]))
        print('Max b: ', tf.reduce_max(output_v[:, :, :, :, 2]))
        print('Min L: ', tf.reduce_min(output_v[:, :, :, :, 0]))
        print('Min a: ', tf.reduce_min(output_v[:, :, :, :, 1]))
        print('Min b: ', tf.reduce_min(output_v[:, :, :, :, 2]))
